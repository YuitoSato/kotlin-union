    ...
    publications {
        create<MavenPublication>("mavenJava") {
            ...
            pom {
                ...
                description.set("Union Type for Kotlin")
                url.set("https://github.com/YuitoSato/kotlin-union")
                licenses {
                    license {
                ...
                scm {
                    connection.set("scm:git:git@github.com:YuitoSato/kotlin-union.git")
                    developerConnection.set("git@github.com:YuitoSato/kotlin-union.git")
                    url.set("https://github.com/YuitoSato/kotlin-union")
                }
            }
        }
